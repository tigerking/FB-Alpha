...
void __fastcall supbtime_main_write_word(unsigned int address, unsigned short data)
{
...
void __fastcall supbtime_main_write_byte(unsigned int address, unsigned char data)
{
	switch (address)
	{
		case 0x100000:
...
unsigned short __fastcall supbtime_main_read_word(unsigned int address)
{
...
unsigned char __fastcall supbtime_main_read_byte(unsigned int address)
{
	switch (address)
	{
		case 0x180000:
