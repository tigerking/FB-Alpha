...
static int DecodeBoot3PROMs()
{
	unsigned char *tmp = DrvGfxROM2 + 0x8000; // empty before gfx decode
...
static int DrvFrame()
{
	...
	int nInterleave = 100;
	int nCyclesTotal[4] = { 3072000 / 60, 3072000 / 60, 3072000 / 60, 3072000 / 60 };
